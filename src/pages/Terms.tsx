    ...
    <Container>
      <Row>
        <p style={{ textAlign: "left" }}>
          ...
          related to it, still belong to Youssef adbib. Youssef adbib is
          ...
          very clear to you exactly what you’re paying for. The Karny app stores
          and processes personal data that you have provided to us, to provide
          my Service. It’s your responsibility to keep your phone and access to
          ...
          features and it could mean that the Karny app won’t work properly or
          ...
          providers used by the app Google Play Services Facebook You should be
          aware that there are certain things that Youssef adbib will not take
          ...
          provided by your mobile network provider, but Youssef adbib cannot
          ...
          from the bill payer for using the app. Along the same lines, Youssef
          adbib cannot always take responsibility for the way you use the app
          i.e. You need to make sure that your device stays charged – if it runs
          out of battery and you can’t turn it on to avail the Service, Youssef
          adbib cannot accept responsibility. With respect to Youssef adbib’s
          ...
          to you. Youssef adbib accepts no liability for any loss, direct or
          ...
          requirements for the both systems(and for any additional systems we
          ...
          Youssef adbib does not promise that it will always update the app so
          ...
          <br />
          <b>Changes to This Terms andConditions</b> <br />I may update our
          Terms and Conditions from time to time. Thus, you are advised to
          ...
          <b>Contact Us</b>
          <br />
          Terms & ConditionsIf you have any questions or suggestions about my
          Terms and Conditions, do not hesitate to contact me at
          mradbib@gmail.com.
        </p>
      </Row>
    </Container>
