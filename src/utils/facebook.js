      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            this,
            (_ref =
              FacebookLogin.__proto__ ||
              Object.getPrototypeOf(FacebookLogin)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
        ...
        (_this.responseApi = function (authResponse) {
          window.FB.api(
            "/me",
            { locale: _this.props.language, fields: _this.props.fields },
            function (me) {
        ...
        (_this.click = function (e) {
          if (
            !_this.state.isSdkLoaded ||
            _this.state.isProcessing ||
          ...
          if (_this.props.isMobile && !disableMobileRedirect) {
            window.location.href =
              ...
              (0, _objectToParams2.default)(params);
          } else {
      ...
      value: function style() {
        ...
        if (this.props.cssClass === defaultCSS) {
          return _react2.default.createElement("style", {
            dangerouslySetInnerHTML: { __html: _facebook2.default },
          });
        }
        return false;
      },
